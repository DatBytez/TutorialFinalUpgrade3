//package ui;
//
//import static managers.SceneManager.GAME_OVER;
...
//			a.drawImage(playing.getTowerManager().getTowerImgs()[b.getId()], b.x, b.y, b.width, b.height);
...
//			a.drawString("Game is Paused!", 110, 790);
//		}
//
//		// Lives
//		a.setColor(Color.black);
//		a.drawString("Lives: " + lives, 110, 750);
//
//	}
//
//	private void drawTowerCost(Artist a) {
//		a.setColor(Color.gray);
//		a.fillRect(280, 650, 120, 50);
//		a.setColor(Color.black);
//		a.drawRect(280, 650, 120, 50);
//
//		a.drawString("" + getTowerCostName(), 285, 670);
//		a.drawString("Cost: " + getTowerCostCost() + "g", 285, 695);
//
//		// Show this if player lacks gold for the selected tower.
//		if (isTowerCostMoreThanCurrentGold()) {
//			a.setColor(Color.RED);
//			a.drawString("Can't Afford", 270, 725);
//
//		}
//
//	}
...
//	}
//
//	private void drawGoldAmount(Artist a) {
//		a.drawString("Gold: " + gold + "g", 110, 725);
//
//	}
//
//	private void drawWaveInfo(Artist a) {
//		a.setColor(Color.black);
//		a.setFont(new Font("LucidaSans", Font.BOLD, 20));
//		drawWaveTimerInfo(a);
//		drawEnemiesLeftInfo(a);
//		drawWavesLeftInfo(a);
//
//	}
//
//	private void drawWavesLeftInfo(Artist a) {
//		int current = playing.getWaveManager().getWaveIndex();
//		int size = playing.getWaveManager().getWaves().size();
//		a.drawString("Wave " + (current + 1) + " / " + size, 425, 770);
//
//	}
//
//	private void drawEnemiesLeftInfo(Artist a) {
//		int remaining = playing.getEnemyManger().getAmountOfAliveEnemies();
//		a.drawString("Enemies Left: " + remaining, 425, 790);
//	}
//
//	private void drawWaveTimerInfo(Artist a) {
//		if (playing.getWaveManager().isWaveTimerStarted()) {
//
//			float timeLeft = playing.getWaveManager().getTimeLeft();
//			String formattedText = formatter.format(timeLeft);
//			a.drawString("Time Left: " + formattedText, 425, 750);
//		}
//	}
//
//	private void drawDisplayedTower(Artist a) {
//		if (displayedTower != null) {
//			a.setColor(Color.gray);
//			a.fillRect(410, 645, 220, 85);
//			a.setColor(Color.black);
//			a.drawRect(410, 645, 220, 85);
//			a.drawRect(420, 650, 50, 50);
//			a.drawImage(playing.getTowerManager().getTowerImgs()[displayedTower.getTowerType()], 420, 650, 50, 50);
//			a.setFont(new Font("LucidaSans", Font.BOLD, 15));
//			a.drawString("" + Towers.GetName(displayedTower.getTowerType()), 480, 660);
//			a.drawString("ID: " + displayedTower.getId(), 480, 675);
//			a.drawString("Tier: " + displayedTower.getTier(), 560, 660);
//			drawDisplayedTowerBorder(a);
//			drawDisplayedTowerRange(a);
//
//			// Sell button
//			sellTower.draw(a);
//			drawButtonFeedback(a, sellTower);
//
//			// Upgrade Button
//			if (displayedTower.getTier() < 3 && gold >= getUpgradeAmount(displayedTower)) {
//				upgradeTower.draw(a);
//				drawButtonFeedback(a, upgradeTower);
//			}
//
//			if (sellTower.isMouseOver()) {
//				a.setColor(Color.red);
//				a.drawString("Sell for: " + getSellAmount(displayedTower) + "g", 480, 695);
//			} else if (upgradeTower.isMouseOver() && gold >= getUpgradeAmount(displayedTower)) {
//				a.setColor(Color.blue);
//				a.drawString("Upgrade for: " + getUpgradeAmount(displayedTower) + "g", 480, 695);
//			}
//
//		}
//
...
//	}
//
//	private void drawDisplayedTowerRange(Artist a) {
//		a.setColor(Color.white);
//		a.drawOval(displayedTower.getX() + 16 - (int) (displayedTower.getRange() * 2) / 2, displayedTower.getY() + 16 - (int) (displayedTower.getRange() * 2) / 2, (int) displayedTower.getRange() * 2,
//				(int) displayedTower.getRange() * 2);
//
//	}
//
//	private void drawDisplayedTowerBorder(Artist a) {
//
//		a.setColor(Color.CYAN);
//		a.drawRect(displayedTower.getX(), displayedTower.getY(), 32, 32);
//
//	}
//
