...
//import objects.ProjectileKa;
//import objects.TowerKa;
...
//	private ArrayList<ProjectileKa> projectiles = new ArrayList<>();
...
//	}
//
//	public void newProjectile(TowerKa t, Enemy e) {
...
//		}
//
//		for (ProjectileKa p : projectiles)
//			if (!p.isActive())
...
//				}
//
//		projectiles.add(new ProjectileKa(t.getX() + 16, t.getY() + 16, xSpeed, ySpeed, t.getDmg(), rotate, proj_id++, type));
//
//	}
//
//	public void update() {
...
//	}
//
//	private void explodeOnEnemies(ProjectileKa p) {
...
//	}
//
//	private boolean isProjHittingEnemy(ProjectileKa p) {
////		for (Enemy e : playing.getEnemyManger().getEnemies()) {
////			if (e.isAlive())
...
//	}
//
//	private boolean isProjOutsideBounds(ProjectileKa p) {
//		if (p.getPos().x >= 0)
//			if (p.getPos().x <= 640)
//				if (p.getPos().y >= 0)
//					if (p.getPos().y <= 800)
...
//	}
//
//	private int getProjType(TowerKa t) {
