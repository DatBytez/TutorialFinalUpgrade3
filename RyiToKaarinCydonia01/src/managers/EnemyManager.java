...
//	private PathPointKa start, end;
//	private int HPbarWidth = 20;
//	private BufferedImage slowEffect;
//	private int[][] roadDirArr;
//
//	public EnemyManager(Playing playing, PathPointKa start, PathPointKa end) {
...
//	}
//
//	private PathPointKa getEnemyTile(Enemy e) {
//
//		switch (e.getLastDir()) {
//		case LEFT:
//			return new PathPointKa((int) ((e.getX() + 31) / 32), (int) (e.getY() / 32));
//		case UP:
//			return new PathPointKa((int) (e.getX() / 32), (int) ((e.getY() + 31) / 32));
//		case RIGHT:
//		case DOWN:
//			return new PathPointKa((int) (e.getX() / 32), (int) (e.getY() / 32));
//
//		}
//
//		return new PathPointKa((int) (e.getX() / 32), (int) (e.getY() / 32));
//	}
//
//	private boolean isTilesTheSame(PathPointKa currTile, PathPointKa newTile) {
