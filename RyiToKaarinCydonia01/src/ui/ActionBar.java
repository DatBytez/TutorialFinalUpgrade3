...
//	private TowerKa selectedTower;
//	private TowerKa displayedTower;
...
//	private int getUpgradeAmount(TowerKa displayedTower) {
//		return (int) (helpz.Constants.Towers.GetTowerCost(displayedTower.getTowerType()) * 0.3f);
//	}
//
//	private int getSellAmount(TowerKa displayedTower) {
...
//	public void displayTower(TowerKa t) {
//		displayedTower = t;
//	}
//
...
//						return;
//
//					selectedTower = new TowerKa(0, 0, -1, b.getId());
